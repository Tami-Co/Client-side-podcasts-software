...
import { Backdrop, BottomNavigationAction, Box, CircularProgress, Fab, Modal, TextField } from '@mui/material';
import React, { useCallback, useEffect, useMemo, useRef, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux';
import { Outlet, useNavigate, useParams } from 'react-router'
// import fetchFilePodcast from '../Podcast/podcastSlice';
// import fetchHandleDownloadNow from '../Podcast/podcastSlice';
// import fetchImgPodcast from '../Podcast/podcastSlice';
...
import './singlePodcastLecturerCSS.css'
import ErrorIcon from '@mui/icons-material/Error';
import { fetchFilePodcast, fetchHandleDownloadNow, fetchImgPodcast } from '../Podcasts/podcastSlice';
    ...
    return (
        <div className="single-podcast-container">
            {loading ? (
                ...
                <div>
                    {file && (
                        <Box sx={{ textAlign: 'right', pr: '2%', display: 'flex', flexDirection: 'column', paddingTop: '2%' }}>
        ...
        <img src={getImageUrl(currentImgPodcast)} alt="Podcast Image" />
                  ...
                  <video
                    controls type title='podcast' style={{ width: '40vw' }} controlsList="nodownload">
                    <source src={file}
                      type="video/mp4"
                    />
                  </video>
